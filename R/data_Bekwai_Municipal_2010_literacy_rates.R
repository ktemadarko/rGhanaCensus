#' @title Bekwai Municipal District level Literacy estimates from the 2010 census
#'
...
#' \item{District_Name}{A factor with 1 level which is Bekwai Municipal. }
...
#' @source
#' \itemize{
#' \item{Data manually copied on : 12th May, 2025}{The 2010 Population and Housing Census District Analytical Report for the Bekwai Municipal District published by the Ghana Statistical Service in 2014}
#' }
