...
#' @source
#' \itemize{
#' \item{The 2010 Population and Housing Census District Analytical Report for the Asokore Mampong Municipal District published by the Ghana Statistical Service in 2014}
#' }
