#' @title Asokore Mampong Municipal District level Literacy estimates from the 2010 census
#'
#' @description The `Asokore_Mampong_Municipal_2010_literacy_rates` dataset contains
#' literacy percentages for respondents aged 11 years and above. This data was
#' collected from the Asokore Mampong Municipal district during the 2010 Ghana Population and
#' Housing Census.
#'
#' @format A data frame with 3 rows and 10 variables:
#' \describe{
#' \item{Region_Name}{A factor with 1 level which is Ashanti.}
#' \item{District_Name}{A factor with 1 level which is Asokore Mampong Municipal. }
...
#' @source
#' \itemize{
#' \item{Data manually copied on : 14th May, 2025}{The 2010 Population and Housing Census District Analytical Report for the Asokore Mampong Municipal District published by the Ghana Statistical Service in 2014}
#' }
#' \url{https://statsghana.gov.gh/gssmain/fileUpload/2010%20Dist%20Rep/Asokore%20Mampong.pdf}


"Asokore_Mampong_Municipal_2010_literacy_rates"
