#' @title Asante Akim South District level Literacy estimates from the 2010 census
#'
#' @description The `Asante_Akim_South_2010_literacy_rates` dataset contains
#' literacy percentages for respondents aged 11 years and above. This data was
#' collected from the Asante Akim South district during the 2010 Ghana Population and
#' Housing Census.
#'
#' @format A data frame with 3 rows and 10 variables:
#' \describe{
#' \item{Region_Name}{A factor with 1 level which is Ashanti.}
#' \item{District_Name}{A factor with 1 level which is Asante Akim South. }
...
#' @source
#' \itemize{
#' \item{Data manually copied on : 14th May, 2025}{The 2010 Population and Housing Census District Analytical Report for the Asante Akim South District published by the Ghana Statistical Service in 2014}
#' }
#' \url{https://www2.statsghana.gov.gh/docfiles/2010_District_Report/Ashanti/ASANTE%20AKIM%20SOUTH.pdf}


"Asante_Akim_South_2010_literacy_rates"
