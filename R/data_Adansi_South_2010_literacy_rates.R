#' @title Adansi South District level Literacy estimates from the 2010 census
#'
#' @description The `Adansi_South_2010_literacy_rates` dataset contains
#' literacy percentages for respondents aged 11 years and above. This data was
#' collected from the Adansi South district during the 2010 Ghana Population and
#' Housing Census.
#'
#' @format A data frame with 3 rows and 11 variables:
#' \describe{
#' \item{Region_Name}{A factor with 1 level which is Ashanti.}
#' \item{District_Name}{A factor with 1 level which is Adansi South. }
...
#' @source
#' \itemize{
#' \item{The 2010 Population and Housing Census District Analytical Report for the Adansi South District published by the Ghana Statistical Service in 2014}
#' }
