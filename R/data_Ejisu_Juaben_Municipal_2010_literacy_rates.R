...
#' collected from the Ejisu Juaben Municipal district during the 2010 Ghana Population and
#' Housing Census.
#'
...
#' @source
#' \itemize{
#' \item{The 2010 Population and Housing Census District Analytical Report for the Ejisu Juaben Municipal District published by the Ghana Statistical Service in 2014}
#' }
