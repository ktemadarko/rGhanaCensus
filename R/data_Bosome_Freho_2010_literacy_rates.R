...
#' @source
#' \itemize{
#' \item{Data manually copied on : 12th May, 2025}{The 2010 Population and Housing Census District Analytical Report for the Bosome Freho District published by the Ghana Statistical Service in 2014}
#' }
