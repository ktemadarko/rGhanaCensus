...
Subsetting the data to filter and keep rows where age is less than 19.
...
children_gh_phc_2021_ten_percent_sample <- phc_2021_sample[1:13,100] |> 
  dplyr::collect()
...
arrow::write_dataset(dataset = children_gh_phc_2021_ten_percent_sample,
                     partitioning = "subdist",
 
                    path = "~/Ama_Owusu-Darko_RCode_sample/rGhanaCensus/data/children_gh_phc_2021_ten_percent_sample_parquet_file")
